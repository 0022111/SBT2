...
// Veazy/Venty command write masks
export const VentyVeazyWriteMasks = {
  SET_TEMPERATURE: 1 << 1,
  SET_BOOST: 1 << 2,
  SET_SUPERBOOST: 1 << 3,
  HEATER: 1 << 5,
...
export type VentyVeazyWriteMasks = (typeof VentyVeazyWriteMasks)[keyof typeof VentyVeazyWriteMasks];

// Veazy/Venty settings byte 14 bits
export const VentyVeazySettingsBits = {
  UNIT: 1 << 0,
...
export type VentyVeazySettingsBits = (typeof VentyVeazySettingsBits)[keyof typeof VentyVeazySettingsBits];

export const VentyVeazySettings2Bits = {
  BLE_PERMANENT: 1 << 0,
} as const;
export type VentyVeazySettings2Bits = (typeof VentyVeazySettings2Bits)[keyof typeof VentyVeazySettings2Bits];

// --- Service UUIDs ---

export const VolcanoServiceUUIDs = {
...
export type VolcanoServiceUUIDs = (typeof VolcanoServiceUUIDs)[keyof typeof VolcanoServiceUUIDs];

export const VentyVeazyServiceUUIDs = {
  Primary: "00000000-5354-4f52-5a26-4249434b454c",
  GenericAccess: "00001800-0000-1000-8000-00805f9b34fb",
} as const;
export type VentyVeazyServiceUUIDs = (typeof VentyVeazyServiceUUIDs)[keyof typeof VentyVeazyServiceUUIDs];

export const CraftyServiceUUIDs = {
...
export type CraftyServiceUUIDs = (typeof CraftyServiceUUIDs)[keyof typeof CraftyServiceUUIDs];

// --- Characteristic UUIDs ---

export const VolcanoCharacteristicUUIDs = {
...
export type VolcanoCharacteristicUUIDs = (typeof VolcanoCharacteristicUUIDs)[keyof typeof VolcanoCharacteristicUUIDs];

export const VentyVeazyCharacteristicUUIDs = {
  control: "00000001-5354-4f52-5a26-4249434b454c",
  deviceName: "00002a00-0000-1000-8000-00805f9b34fb",
} as const;
export type VentyVeazyCharacteristicUUIDs = (typeof VentyVeazyCharacteristicUUIDs)[keyof typeof VentyVeazyCharacteristicUUIDs];

export const CraftyCharacteristicUUIDs = {
...
export type CraftyCharacteristicUUIDs = (typeof CraftyCharacteristicUUIDs)[keyof typeof CraftyCharacteristicUUIDs];
